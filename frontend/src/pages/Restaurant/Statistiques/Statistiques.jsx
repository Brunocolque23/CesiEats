...
const Statistiques = () => {
  ...
  const getTotalOrders = async () => {
    try {
      const response = await axios.get(`${url}/api/restaurant/statsOrder`, {
  ...
  const getTotalEarnings = async () => {
    try {
      const response = await axios.get(`${url}/api/restaurant/statsEarning`, {
        params: { startDate, endDate, product: selectedProduct, state: selectedState }
      });
      if (response.data.success) {
  ...
  const getOrdersPerDay = async () => {
    try {
        const response = await axios.get(`${url}/api/restaurant/ordersPerDay`, {
            params: { startDate, endDate, product: selectedProduct, state: selectedState }
        });
        if (response.data.success) {
...
const getOrdersPerProduct = async () => {
  try {
      const response = await axios.get(`${url}/api/restaurant/ordersPerProduct`, {
          params: { startDate, endDate, product: selectedProduct, state: selectedState }
      });
      if (response.data.success) {
  ...
  const getOrdersPerState = async () => {
    try {
      const response = await axios.get(`${url}/api/restaurant/ordersPerState`, {
        params: { startDate, endDate, product: selectedProduct, state: selectedState }
      });
      if (response.data.success) {
  ...
  const getTotalItems = async () => {
    try {
      const response = await axios.get(`${url}/api/restaurant/statsTotalItems`, {
        params: { startDate, endDate, product: selectedProduct, state: selectedState }
      });
      if (response.data.success) {
